...
def downloadimg(url, book):
    ...
    if 'BookImg' in os.listdir(r'D:\大学\大二下\Web技术\WebBigHW_backend\BookInfo'):
        pass
    else:
        os.mkdir(r'D:\大学\大二下\Web技术\WebBigHW_backend\BookInfo\BookImg')
    os.chdir(r'D:\大学\大二下\Web技术\WebBigHW_backend\BookInfo\BookImg')
    # 返回img的二进制流
...
if __name__ == '__main__':
    ...
    bookdata.to_csv(r'D:\大学\大二下\Web技术\WebBigHW_backend\BookInfo\book.csv', encoding='utf_8_sig', index=False)
    print("图书信息写入本地成功")
