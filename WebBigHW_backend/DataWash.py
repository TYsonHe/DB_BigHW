...
# 先读取数据文件
data = pd.read_csv(r'D:\大学\大二下\Web技术\WebBigHW_backend\BookInfo\book.csv')
...
a.to_csv(r'D:\大学\大二下\Web技术\WebBigHW_backend\BookInfo\newbook.csv', encoding='utf_8_sig', index=False)